...
![Review Original](../images/review_orig.png "OPR Original Ansicht")

Nach den Modifikationen ergibt sich folgendes Aussehen:

![Review modifiziert](../images/review_modified.png "modifizierte OPR Ansicht")


## Download

Wenn du alle Hinweise gelesen und verstanden sowie das [Basis-Skript](../rhs-base.user.js) installiert hast, kannst du dieses Skript [installieren](../rhs-reviewImproveCSS.user.js).
