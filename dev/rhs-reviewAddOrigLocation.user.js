// ==UserScript==
// @name           RHS - review Add Orig Location
...
// @downloadURL    https://altertobi.github.io/Recon-Helper-Scripts/dev/rhs-reviewAddOrigLocation.user.js
// @updateURL      https://altertobi.github.io/Recon-Helper-Scripts/dev/rhs-reviewAddOrigLocation.meta.js
...
(function() {
  ...
  function addOrigMarker() {
    ...
    if ((counter-- > 0)) {
      ...
      if (edit.what.location) {
        ...
        w.rhs.f.awaitElem(mapSelector).then( elem => {
          const gmap = elem;
  ...
  w.addEventListener("OPRReviewPageEditLoaded", () => {
    counter = maxtries;
    clearTimeout(timerId);
    timerId = setTimeout(addOrigMarker, 250);
  } );
