...
// @downloadURL    https://altertobi.github.io/Recon-Helper-Scripts/dev/rhs-imageMod.user.js
// @updateURL      https://altertobi.github.io/Recon-Helper-Scripts/dev/rhs-imageMod.meta.js
...
(function() {
  ...
  function addFullSizeImageLinksReview() {
    ...
    let elem, imageUrl;
    const myData = w.rhs.g.reviewPageData();
  ...
  function addFullSizeImageLinksNomDetail() {
    ...
    let imageUrl;
    const myData = w.rhs.g.nominationDetail();
  ...
  w.addEventListener("OPRNominationDetailLoaded", () => {setTimeout(addFullSizeImageLinksNomDetail, 100);});
  w.addEventListener("OPRReviewPageLoaded", () => {setTimeout(addFullSizeImageLinksReview, 100);});
