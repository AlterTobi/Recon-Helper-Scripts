...
![Review Original](../images/review_orig.png "OPR Original View")

After the modifications, it looks like this:

![Review modified](../images/review_modified.png "modified OPR view")


## Download

If you have read and understood all instructions and have installed the [base script](../rhs-base.user.js), you can [install this script](../rhss-reviewImproveCSS.user.js).
