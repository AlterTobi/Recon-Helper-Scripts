...
// @downloadURL    https://altertobi.github.io/Recon-Helper-Scripts/dev/rhs-oprStats.user.js
// @updateURL      https://altertobi.github.io/Recon-Helper-Scripts/dev/rhs-oprStats.meta.js
  ...
  function handleShowcase() {
    ...
    function buttonFuncs() {
      ...
      function showMap() {
        ...
        script.setAttribute("src", "https://maps.googleapis.com/maps/api/js?key=&&libraries=visualization,geometry,marker&loading=async&callback=initMap");
        body.appendChild(script);
      }
